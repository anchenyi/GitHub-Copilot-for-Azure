...
| **create** | Create new hosted agent applications, inspect or test agents locally. Supports Microsoft Agent Framework, LangGraph, or custom frameworks in Python or C#. Downloads starter samples from foundry-samples repo. | [create](foundry-agent/create/create.md) |
...
| Inspect or test an agent locally | create (Inspect Locally) |

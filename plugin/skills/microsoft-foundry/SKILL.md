...
| **create** | Create new hosted agent applications, debug or test agents locally. Supports Microsoft Agent Framework, LangGraph, or custom frameworks in Python or C#. Downloads starter samples from foundry-samples repo. | [create](foundry-agent/create/create.md) |
...
| Debug or test an agent locally | create (Step 6 / Step B7) |
